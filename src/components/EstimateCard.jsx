...
export default function EstimateCard({ estimate, handleDeleteEstimate }) {
  ...
  return (
    <li
      className="w-50 h-70 bg-cyan-700 flex flex-col justify-center items-center cursor-pointer relative hover:bg-cyan-600 hover:scale-103 hover:shadow-2xl transition-all rounded-xl"
    ...
    >
      ...
      <h1 className="text-slate-200 text-xl font-medium">{estimate.name}</h1>
