...
export default function Header() {
  ...
  return (
    <div className="flex flex-row gap-4 justify-between items-center lg:mx-38 md:mx-24 sm:mx-14 mx-4 md:px-8 sm:px-4 px-2 sm:py-6 py-4 border-x border-gray-700">
